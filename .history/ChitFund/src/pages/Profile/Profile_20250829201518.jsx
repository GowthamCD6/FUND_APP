        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.sectionContainer}>
            ...
            <View style={styles.menuSection}>
              <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('AccountD')}>
              ...
              <TouchableOpacity style={[styles.menuItem, styles.menuItemBorder]} onPress={() => navigation.navigate('Nominee')}>
                <View style={styles.menuItemLeft}>
            <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>

...
const Profile = () => {
  ...
  const accountDAnim = useRef(new Animated.Value(Dimensions.get('window').width)).current;
  const nomineeAnim = useRef(new Animated.Value(Dimensions.get('window').width)).current;

  useEffect(() => {
    if (showAccountD) {
      Animated.timing(accountDAnim, {
        toValue: 0,
        duration: 350,
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={{ flex: 1 }}>
        {/* Main Profile Content (hidden when overlay is open) */}
        {!showAccountD && !showNominee && (
          <>
            ...
            <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.sectionContainer}>
                ...
                <View style={styles.menuSection}>
                  ...
                  <TouchableOpacity style={[styles.menuItem, styles.menuItemBorder]} onPress={() => setShowNominee(true)}>
                    <View style={styles.menuItemLeft}>
        ...
        {showAccountD && (
          <Animated.View style={{
            ...
            backgroundColor: '#fff',
            zIndex: 10,
            transform: [{ translateX: accountDAnim }],
          }}>
            <AccountD onBack={() => setShowAccountD(false)} />
          </Animated.View>
        )}
        {/* Nominee Slide-in Overlay */}
        {showNominee && (
          <Animated.View style={{
            position: 'absolute',
            top: 0,

...
const Profile = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
          ...
          {!showAccountD && !showNominee && (
            <>
              ...
              <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                {/* ...existing profile, settings, general, follow, and nav sections... */}
      ...
      {/* AccountD Slide-in Overlay (covers everything, high zIndex) */}
      {showAccountD && (
        <Animated.View style={{
          position: 'absolute',
          top: 0,
      ...
      {/* Nominee Slide-in Overlay (covers everything, high zIndex) */}
      {showNominee && (
        <Animated.View style={{
          position: 'absolute',
          top: 0,

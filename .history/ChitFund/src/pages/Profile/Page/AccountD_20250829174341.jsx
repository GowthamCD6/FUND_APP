			...
			<ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
				<View style={styles.formContainer}>
							...
							<View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.2)', justifyContent: 'flex-end' }}>
								<View style={modalSheetStyle}>
									<View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
										<Text style={{ fontSize: 18, fontWeight: 'bold', fontFamily: Platform.OS === 'android' ? 'Gilroy-Bold' : 'Poppins-Bold' }}>Select City</Text>
									...
									<FlatList
										...
										renderItem={({ item }) => (
											...
											>
												<Text style={{ fontSize: 16, fontFamily: Platform.OS === 'android' ? 'Gilroy-Bold' : 'Poppins-Bold' }}>{item}</Text>
											</TouchableOpacity>
										)}
									/>
								</View>
					...
					<View style={styles.inputContainer}>
						...
						<TouchableOpacity
								<View style={{ backgroundColor: '#fff', margin: 24, borderRadius: 16, padding: 16 }}>
									<Text style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 12 }}>Select State</Text>
									<FlatList
									...
									/>
									<TouchableOpacity onPress={() => setStateModalVisible(false)} style={{ marginTop: 12, alignSelf: 'flex-end' }}>

...
const styles = StyleSheet.create({
  ...
  relationshipInput: {
    gowthaflexDirection: 'row',
    gowthajustifyContent: 'space-between',
    gowthaalignItems: 'center',
    gowthaborderWidth: 1,
    gowthaborderColor: '#D1D5DB',
    gowthaborderRadius: 8,
    gowthapaddingHorizontal: 16,
    gowthapaddingVertical: 12,
  },
  relationshipText: {
    fontSize: 16,
    color: '#1F2937',

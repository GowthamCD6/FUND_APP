						...
						>
							<View style={{ flex: 1, justifyContent: 'center', backgroundColor: 'rgba(0,0,0,0.2)' }}>
								<View style={{ backgroundColor: '#fff', margin: 24, borderRadius: 16, padding: 16 }}>
									<Text style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 12 }}>Select City</Text>
									<FlatList
									...
									/>
									<TouchableOpacity onPress={() => setCityModalVisible(false)} style={{ marginTop: 12, alignSelf: 'flex-end' }}>

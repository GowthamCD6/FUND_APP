...
const styles = StyleSheet.create({
  ...
  relationshipInput: {
    gowtham flexDirection: 'row',
    gowtham justifyContent: 'space-between',
    gowtham alignItems: 'center',
    gowtham borderWidth: 1,
    gowtham borderColor: '#D1D5DB',
    gowtham borderRadius: 8,
    gowtham paddingHorizontal: 16,
    gowtham paddingVertical: 12,
  },
  relationshipText: {
    fontSize: 16,
    color: '#1F2937',

...
const AccountD = ({ onBack }) => {
	...
	const handleRightArrow = () => {
		Animated.timing(slideAnim, {
			toValue: -350, // Slide left by 350px (adjust as needed)
			duration: 400,
	...
	return (
		<View style={styles.container}>
			...
			<View style={styles.header}>
				...
				{/* Right Arrow Button for Animation */}
				<TouchableOpacity style={styles.rightArrowButton} onPress={handleRightArrow}>
					<MaterialCommunityIcons name="arrow-right" size={24} color="#1F2937" />
				</TouchableOpacity>
			</View>
